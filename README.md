...
* I have currently ordered all of the hardware listed in the [Hardware](https://github.com/VKG7125/SenseCAP-Solar-P1-Relay-Deployment/tree/main?tab=readme-ov-file#%EF%B8%8F-hardware-obtained-purchased) section below. I will determine if I should purchase a 5.8 dBi fiberglass antenna later. The main goal right now is actually getting it up and running — regardless of range.
